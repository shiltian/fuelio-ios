...
- Protected by your Apple ID credentials
- Encrypted in transit and at rest by Apple
- Not accessible to the developer or any third party

You can disable iCloud Sync at any time from the app's Settings. You can also delete your iCloud data from within the app.
...
- Any server-side components operated by the developer

The only network communication the app performs is with Apple's iCloud servers, and only when you have explicitly enabled iCloud Sync.

## CSV Export

When you export your data as a CSV file, the file is saved to a location you choose on your device. The exported file never leaves your device unless you explicitly share it yourself.
...
If this privacy policy is updated, the changes will be reflected in the "Last updated" date above. Continued use of the app after any changes constitutes acceptance of the updated policy.
